		...
		for (int i = bs.nextSetBit(0); i >= 0; i = bs.nextSetBit(i+1)) {
		     switch (i) {
				...
				case 46:	rules.put(46, "¬(p↔q) ≡ ¬p↔q");
							break;
				case 47:	rules.put(47, "¬(p↔q) ≡ (p∧¬q)∨(¬p∧q) -- Exclusive Or");
							break;
				...
				case 105:	rules.put(105, "θ ≡ ∃p[θ]");
							break;
				case 106:	rules.put(106, "¬p∧q ≡ ¬(q→p)");
				break;
				case 107:	rules.put(107, "(¬p∧¬q)v(p∧q) ≡ p↔q");
				break;
				case 108:	rules.put(108, "(¬p∧q)v(p∧¬q) ≡ ¬(p↔q)");
				break;
				case 109:	rules.put(109, "∀x[θ∨φ]	≡ θ∨∀x[φ]");
				break;
				case 110:	rules.put(110, "∃x[θ∧φ]	≡ θ∧∃x[φ]");
				break;
				case 111:	rules.put(111, "θ∧∃x[φ]	≡ ∃x[θ∧φ]");
				break;
				case 112:	rules.put(112, "θ∨∀x[φ]	≡ ∀x[θ∨φ]");
				break;
